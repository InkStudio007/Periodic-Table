...
LEXERS = {
    ...
    'CssDjangoLexer': ('pip._vendor.pygments.lexers.templates', 'CSS+Django/Jinja', ('css+djangoenv', 'css+jinja'), ('*.css.j2', '*.css.jinja2'), ('text/css+djangoenv', 'text/css+jinja')),
    ...
    'DjangoLexer': ('pip._vendor.pygments.lexers.templates', 'Django/Jinja', ('djangoenv', 'jinja'), (), ('application/x-djangoenv-templating', 'application/x-jinja')),
    ...
    'HtmlDjangoLexer': ('pip._vendor.pygments.lexers.templates', 'HTML+Django/Jinja', ('html+djangoenv', 'html+jinja', 'htmldjango'), ('*.html.j2', '*.htm.j2', '*.xhtml.j2', '*.html.jinja2', '*.htm.jinja2', '*.xhtml.jinja2'), ('text/html+djangoenv', 'text/html+jinja')),
    ...
    'JavascriptDjangoLexer': ('pip._vendor.pygments.lexers.templates', 'JavaScript+Django/Jinja', ('javascript+djangoenv', 'js+djangoenv', 'javascript+jinja', 'js+jinja'), ('*.js.j2', '*.js.jinja2'), ('application/x-javascript+djangoenv', 'application/x-javascript+jinja', 'text/x-javascript+djangoenv', 'text/x-javascript+jinja', 'text/javascript+djangoenv', 'text/javascript+jinja')),
    ...
    'XmlDjangoLexer': ('pip._vendor.pygments.lexers.templates', 'XML+Django/Jinja', ('xml+djangoenv', 'xml+jinja'), ('*.xml.j2', '*.xml.jinja2'), ('application/xml+djangoenv', 'application/xml+jinja')),
